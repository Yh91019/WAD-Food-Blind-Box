                                ...
                                >
                                    ...
                                    <td class="table-actions">
                                        ...
                                        <form
                                            ...
                                            class="delete-form restaurant-delete-form"
                                        >
...
<script src="<?php echo BASE_URL; ?>/js/admin-restaurants.js?v=<?php echo filemtime(__DIR__ . '/../js/admin-restaurants.js'); ?>"></script>
